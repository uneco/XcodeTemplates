...
@interface ___FILEBASENAME___ () <PHContentEditingController>
@property PHContentEditingInput* input;
@end
...
- (void)finishContentEditingWithCompletionHandler:(void (^)(PHContentEditingOutput * output))completionHandler {
